...
where $\pi_2(x) = \#\{p \le x : p, p+2 \in \mathbb{P}\}$ is the twin-prime counting function. This asserts that every dyadic interval $(x, 2x]$ past $x = 11$ contains at least one twin prime.
